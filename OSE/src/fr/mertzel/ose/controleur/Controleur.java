...
public class Controleur implements MouseListener, ActionListener {
	...
	public void actionPerformed(ActionEvent evt){
		...
		if(source == vue.getItemOuvrir()){
			...
			modele.reorienterPoste(this.position,Orientation.NORD) ;
		}
		else if(source == vue.getItemReorienterEst()){
			modele.reorienterPoste(this.position,Orientation.EST) ;
		}
		else if(source == vue.getItemReorienterSud()){
			modele.reorienterPoste(this.position,Orientation.SUD) ;
		}
		else if(source == vue.getItemReorienterOuest()){
			modele.reorienterPoste(this.position,Orientation.OUEST) ;
		}
